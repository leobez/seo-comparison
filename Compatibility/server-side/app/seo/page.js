      ...
      <div className='hidden sm:block sticky w-56 top-0 h-[100vh] border-r border-black p-4 '>
          ...
          <div>
              <ul className='flex flex-col text-sm'>
                <li className='hover:bg-slate-300 h-10'><a href='#ferramentas_de_busca' className='h-full w-full flex items-center px-1'>Ferramentas de busca</a></li>
                <li className='hover:bg-slate-300 h-10'><a href='#seo' className='h-full w-full flex items-center px-1'>SEO</a></li>
